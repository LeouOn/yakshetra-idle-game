...
//   evaluatePredicate  -> recursive descent over the Predicate union
//
// Reference: https://redux.js.org/tutorials/fundamentals/part-3-state-actions-reducers

import type { Choice, EffectOp, Event, Predicate } from '@/content/schema';
 ...
 *
 * Order: fixed scalars (age/turn/chosen_lens/alive) -> resources -> skills.
...
/** Recursively evaluate a {@link Predicate}. Pure. */
